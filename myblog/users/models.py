...
class User(AbstractUser):
    ...
    birthday = models.CharField(max_length=20,default='1998-12-24')
    phone = models.CharField(max_length=15,default='17852417983')
    job = models.CharField(max_length=30,default='员工')    
